...
namespace TheHotelApp.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        public RoomsController(IGenericHotelService<Room> genericHotelService, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            string userEmail = _applicationUser?.Email; // will give the user's Email
